        ...
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="space-y-8 font-sans text-base text-slate leading-relaxed">
            {[
              ...
              ['6. Item Condition', 'Items are described accurately at time of listing. Condition is shown as Pristine, Seasoned, Refined, or Veteran based on prior rental count. Wear count reflects rentals completed.'],
