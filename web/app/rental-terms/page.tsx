        ...
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="space-y-8 font-sans text-base text-slate leading-relaxed">
            {[
              ...
              ['6. Item Condition', 'Items are described accurately at time of listing. Condition is assessed as New, Like New, or Good. Wear count reflects prior rentals.'],
              ...
              ['9. Shipping', 'Davenport ships within 2–3 business days. Return shipping is provided via prepaid label from Davenport.'],
