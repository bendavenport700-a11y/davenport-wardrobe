...
const PIECE_COLS = 'id, name, brand, images, rental_fee, buyout_price, wear_count, category, sizes_available, is_featured, is_available, description, color, condition'
